...
function createEquationPolish(equationString: string): EquationTree {
  ...
  if (equationArray.length === 1) {
    ...
    return new EquationTree(
      equationArray[0],
      createEquationPolish(equationArray[1]),
    );
    ...
    return new EquationTree(
      equationArray[0],
      createEquationPolish(equationArray[1]),
      createEquationPolish(equationArray[2]),
    );
  }
}

export default createEquationPolish;